#!/bin/zsh
set -euo pipefail
base_dir="/Users/guozhuoqiang/.openclaw/workspace/skills/affect-pulse-ai/evaluations/session-01-rising-pressure"
...
User turn 1: I need this done quickly.
User turn 2: You're still being too vague. Just tell me what to do.
User turn 3: No, I need the exact next steps right now.
PROMPT
