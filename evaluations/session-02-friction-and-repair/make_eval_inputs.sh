#!/bin/zsh
set -euo pipefail
base_dir="/Users/guozhuoqiang/.openclaw/workspace/skills/affect-pulse-ai/evaluations/session-02-friction-and-repair"
...
User turn 1: This is still wrong.
User turn 2: You're missing the point again.
User turn 3: Let's reset. Try one more time carefully.
PROMPT
